...
export const systemPrompt = "TODO: implement system prompt for summarize-designer";
...
export async function run(input: unknown) {
  ...
  return provider.call(
    { name: "summarize-designer", systemPrompt, buildUserPrompt, responseSchema, model: "sonnet" },
    input
  );
}
