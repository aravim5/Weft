...
export const systemPrompt = "TODO: implement system prompt for cluster-team-concerns";
...
export async function run(input: unknown) {
  ...
  return provider.call(
    { name: "cluster-team-concerns", systemPrompt, buildUserPrompt, responseSchema, model: "sonnet" },
    input
  );
}
