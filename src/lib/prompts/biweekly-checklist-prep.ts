...
export const systemPrompt = "TODO: implement system prompt for biweekly-checklist-prep";
...
export async function run(input: unknown) {
  ...
  return provider.call(
    { name: "biweekly-checklist-prep", systemPrompt, buildUserPrompt, responseSchema, model: "sonnet" },
    input
  );
}
