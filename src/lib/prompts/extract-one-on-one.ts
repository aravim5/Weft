...
export const systemPrompt = "TODO: implement system prompt for extract-one-on-one";
...
export async function run(input: unknown) {
  ...
  return provider.call(
    { name: "extract-one-on-one", systemPrompt, buildUserPrompt, responseSchema, model: "sonnet" },
    input
  );
}
